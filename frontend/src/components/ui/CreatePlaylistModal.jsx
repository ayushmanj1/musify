        ...
        <>
          ...
          >
            <div className="glass-morphism p-8 rounded-[32px] border border-white/10 shadow-[0_32px_64px_rgba(0,0,0,0.5)] relative overflow-hidden group">
              ...
              <div className="absolute -top-24 -right-24 w-48 h-48 bg-lavender/20 blur-[80px] rounded-full group-hover:bg-lavender/30 transition-colors duration-700" />
              
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-white/40 glass-btn">
                      <FiMusic size={24} />
                    </div>
                  ...
                  <button 
                    onClick={onClose}
                    className="w-10 h-10 rounded-full flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 transition-all glass-btn"
                  >
                    <FiX size={20} />
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-white/5 border-2 border-white/5 rounded-2xl px-6 py-4 text-white font-bold placeholder:text-white/20 outline-none transition-all focus:border-lavender/50 focus:bg-white/10 shadow-inner"
                    />
                    <AnimatePresence>
                      {isFocused && (
                        <motion.div 
                          layoutId="input-glow"
                          className="absolute -inset-1 rounded-2xl bg-lavender/20 blur-md -z-10"
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                          exit={{ opacity: 0 }}
                        />
                  ...
                  <div className="flex gap-4">
                    ...
                    <button
                      ...
                      className={`flex-1 py-4 rounded-2xl font-black tracking-widest uppercase text-[12px] shadow-lg transition-all active:scale-95 flex items-center justify-center gap-2 ${
                        name.trim() 
                        ? 'bg-lavender text-black hover:scale-105 hover:shadow-lavender/20 shadow-xl' 
